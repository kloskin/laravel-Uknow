<nav x-data="{ open: false }" class="dashboard-uknow bg-gradient-uknow border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('games.index') }}">
                        <img src="{{ asset('images/logo-circle.svg') }}" alt="Logo Uknow" class="logo-uknow block h-9 w-auto">
                    </a>
                </div>

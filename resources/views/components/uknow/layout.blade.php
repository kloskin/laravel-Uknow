        ...
        <div class="row">
            <div class="col-sm-auto bg-light sticky-top p-0 ">
                <div class="d-flex flex-sm-column flex-row flex-nowrap bg-primary-uknow align-items-center sticky-top menu-uknow">
                    <a href="{{route('home')}}" class="d-block px-3 py-3 py-sm-5 link-dark text-decoration-none" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Icon-only">
                    ...
                    <ul class="d-none d-sm-flex nav nav-pills nav-flush flex-sm-column flex-row flex-nowrap mb-auto mx-auto text-center justify-content-center w-100 h-100 px-3 align-items-center">
                        <li class="nav-item">
                            <a href="{{route('home')}}" class="nav-link py-4 px-2 icon-color-uknow" title="Home" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Home">
                                <i class="fa-solid fa-home fs-1"></i>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('games.index')}}" class="nav-link py-4 px-2 icon-color-uknow" title="Games" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Home">
                                <i class="fa-solid fa-gamepad fs-1"></i>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('favorites.index')}}" class="nav-link py-4 px-2 icon-color-uknow" title="Favorites" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Dashboard">
                                <i class="fa-solid fa-heart fs-1"></i>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('game_statistics.index')}}" class="nav-link py-4 px-2 icon-color-uknow" title="Rankings" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Orders">
                    ...
                    <a href="{{route('profile.edit')}}" class="d-none d-sm-flex align-items-center justify-content-center px-3 py-5 icon-color-uknow" id="profileD" aria-expanded="false">
            ...
            <div id="mobileMenu" class="z-3 d-sm-none d-none position-fixed top-0 start-0 w-100 h-100 bg-dark">
                <div class="d-flex flex-column align-items-center justify-content-center h-100 mt-5">
                    ...
                    <a href="{{route('favorites.index')}}" class="nav-link py-3 px-2 icon-color-uknow" title="Favorites">
                        <i class="fa-solid fa-heart fs-mobile-menu-uknow"></i>
                    </a>
                    <a href="{{route('game_statistics.index')}}" class="nav-link py-3 px-2 icon-color-uknow" title="Rankings">
